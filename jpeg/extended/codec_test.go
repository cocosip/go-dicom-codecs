...
func TestExtendedCodecEncodeDecode8Bit(t *testing.T) {
	...
	encodedFrameInfo := &codec.FrameInfo{
		Width:  uint16(width),
		Height: uint16(height),
	...
	// Encode
	err := extCodec.Encode(context.Background(), src, encoded, nil)
	if err != nil {
	...
	decodedFrameInfo := &codec.FrameInfo{
		Width:  uint16(width),
		Height: uint16(height),
	...
	// Decode
	err = extCodec.Decode(context.Background(), encoded, decoded, nil)
	if err != nil {
...
func TestExtendedCodecWithParameters(t *testing.T) {
	...
	params := NewExtendedParameters().WithQuality(95).WithBitDepth(8)
	...
	err := extCodec.Encode(context.Background(), src, encoded, params)
	if err != nil {
...
func TestExtendedCodecRegistry(t *testing.T) {
	...
	c, exists := registry.Lookup(transfer.JPEGExtended12Bit)
	if !exists {
...
func TestExtendedCodecRejects16Bit(t *testing.T) {
	...
	extCodec := NewExtendedCodec(12, 85)
	if err := extCodec.Encode(context.Background(), src, encoded, nil); err == nil {
...
func TestExtendedCodecRejectsNilInputs(t *testing.T) {
	...
	if err := extCodec.Encode(context.Background(), nil, codecHelpers.NewTestPixelData(frameInfo), nil); err == nil {
		t.Fatal("expected Encode to reject nil source")
	}
	if err := extCodec.Encode(context.Background(), codecHelpers.NewTestPixelData(frameInfo), nil, nil); err == nil {
		t.Fatal("expected Encode to reject nil destination")
	}
	if err := extCodec.Decode(context.Background(), nil, codecHelpers.NewTestPixelData(frameInfo), nil); err == nil {
		t.Fatal("expected Decode to reject nil source")
	}
	if err := extCodec.Decode(context.Background(), codecHelpers.NewTestPixelData(frameInfo), nil, nil); err == nil {
...
func TestExtendedCodecRejectsNoFrames(t *testing.T) {
	...
	if err := extCodec.Encode(context.Background(), src, dst, nil); err == nil {
		t.Fatal("expected Encode to reject source with no frames")
	}
	if err := extCodec.Decode(context.Background(), src, dst, nil); err == nil {
