...
// RuntimeQuantizationSteps mirrors OpenJPEG tcd.c band-to-step-size initialization.
...
func RuntimeQuantizationSteps(encoded []uint16, numLevels, bitDepth int) []float64 {
